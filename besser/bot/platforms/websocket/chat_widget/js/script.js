...
function displayMessage(payload, className) {
    ...
    else if (payload.action === 'bot_reply_options' && payload.message) {
    ...
    else if (payload.action === 'bot_reply_image' && payload.message) {
        messageElement = getMessageImage(payload.message);
    }
    else if (payload.action === 'bot_reply_file' && payload.message) {
        messageElement = getMessageFile(payload.message);
    }
    else if (payload.action === 'bot_reply_dataframe' && payload.message) {
        messageElement = getMessageDataframe(payload.message);
    }
    else if (payload.action === 'bot_reply_rag' && payload.message) {
        messageElement = getMessageRAG(payload.message);
    }
    else if (payload.action === 'bot_reply_location' && payload.message) {
        messageElement = getMessageLocation(payload.message);
    }
    else if (payload.action === 'bot_reply_plotly' && payload.message) {
